export const DATA_SOURCES = [
  ...
  },
  {
    ...
    description: {
      id: "Data anggaran and realisasi belanja fungsi pendidikan dalam APBN — mencakup Kemdikdasmen, Kemenag, dan transfer daerah (DAK Pendidikan, BOS APBN). Dasar analisis pembiayaan pendidikan nasional.",
  ...
  },
  {
    ...
    coverage: { id: "Nasional", en: "National" },
    description: {
      id: "Laporan analitik Bank Dunia tentang sistem pendidikan Indonesia — termasuk \"Indonesia Education Overview\", analisis pembiayaan, and laporan pembelajaran pasca-pandemi. Digunakan sebagai referensi internasional.",
