export const STRINGS = {
  id: {
    ...
    heroDesc: "Platform independen untuk memantau dan memahami data pendidikan Indonesia. Tanyakan apa pun dalam bahasa alami — sistem kami menganalisis data dari BPS, Kemendikdasmen, dan asesmen nasional.",
    ...
    filterAllLabel: "Semua Kategori", // Renamed for clarity as 'filterAll' was duplicate
  ...
  en: {
    ...
    heroDesc: "An independent platform for monitoring and understanding Indonesia's education data. Ask anything in natural language — our system analyses data from BPS, Kemendikdasmen, and national assessments.",
